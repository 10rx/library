        ...
        if (response.status === 200) {
            ...
            if (content) {
                if (content.data) {
                    ...
                    TenrxLibraryLogger.error('API returned data as null when getting Product Category. Content of error is: ', response.error);
                    return null;
                }
            } else {
                TenrxLibraryLogger.error('API returned content as null when getting Product Category. Content of error is: ', response.error);
                return null;
            }
        } else {
